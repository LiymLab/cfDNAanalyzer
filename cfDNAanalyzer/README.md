...
```ruby
bash cfDNAanalyzer.sh -I ./example/input/bam_input.txt -o ./example/output/ -F CNA,NOF,TSS,WPS,EM,FP,NP,PFE,OCF -g hg19 -b ./example/input/test.bed -f ./example/input/hg19.fa > ./cfDNAanalyzer.log
``` 
