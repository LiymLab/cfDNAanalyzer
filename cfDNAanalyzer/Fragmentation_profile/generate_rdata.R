...
gaps.hg38 <- GRanges(gaps$chrom, IRanges(gaps$chromStart,
                                         gaps$chromEnd),
                     type=gaps$type)
gaps.hg38 <- keepSeqlevels(gaps.hg38, paste0("chr", c(1:22)),
                           pruning.mode="coarse")
hsapiens <- BSgenome.Hsapiens.UCSC.hg38::Hsapiens
seqinfo(gaps.hg38) <- seqinfo(hsapiens)[seqlevels(gaps.hg38),]
gaps.hg19 = gaps.hg38
save(gaps.hg19, file="~/projects/202312_cfDNA_integrated_tools/Fragmentation_profile/hg38/gaps.hg19.rda")
...
blacklisted.tib <- read_tsv("~/projects/202312_cfDNA_integrated_tools/Fragmentation_profile/ENCFF356LFX_3.bed",
...
save(filters.hg19, file="~/projects/202312_cfDNA_integrated_tools/Fragmentation_profile/hg38/filters.hg19.rda")
